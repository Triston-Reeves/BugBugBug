    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filed_by', models.CharField(default='', max_length=300)),
                ...
                ('ticket_master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_master', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
